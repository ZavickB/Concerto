...
class Idea
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Tag::class, inversedBy="ideas")
     */
    private $tags;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Status::class, inversedBy="idea")
     * @ORM\JoinColumn(nullable=false)
     */
    private $status;

    /**
     * @ORM\OneToMany(targetEntity=Comment::class, mappedBy="idea")
     */
    private $comments;
